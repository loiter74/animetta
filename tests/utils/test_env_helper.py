...
class TestEnvHelperDetection:
    ...
    def test_detect_windows(self):
        from anima.utils.env_helper import EnvHelper, Environment
...
class TestConvenienceFunctions:
    ...
    def test_detect_env(self):
        from anima.utils.env_helper import detect_env
    ...
    def test_get_data_dir_convenience(self):
        from anima.utils.env_helper import get_data_dir
    ...
    def test_resolve_path_convenience(self):
        from anima.utils.env_helper import resolve_path
