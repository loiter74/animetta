...
class EnvHelper:
    ...
    def convert_windows_to_wsl(windows_path: str) -> str:
        ...
        Args:
            windows_path: Windows path (e.g. E:/anima_data)

        Returns:
            str: WSL path (e.g. /mnt/e/anima_data)
    ...
    def convert_wsl_to_windows(wsl_path: str) -> str:
        ...
        Args:
            wsl_path: WSL path (e.g. /mnt/e/anima_data)

        Returns:
            str: Windows path (e.g. E:\\anima_data)
    ...
    def get_data_dir() -> Path:
        ...
        Priority:
        1. Environment variable ANIMA_DATA_DIR
        ...
        if env == Environment.WINDOWS:
            # Windows: E:/anima_data or user home directory
    ...
    def setup_env_file(target_env: str = None, overwrite: bool = False):
        ...
        logger.info(f"[EnvHelper] 📝 Data directory: {config['ANIMA_DATA_DIR']}")
    ...
    def print_environment_info():
        ...
        print("=" * 50)
        print("  Anima Environment Information")
        print("=" * 50)
