...
class AutoConfig:
    ...
    def get_data_dir(self) -> Path:
        ...
        if platform_name == "windows":
            # Windows: E:/anima_data or C:/Users/xxx/anima_data
            ...
            # WSL: prefer /mnt/e (shared data), fallback to ~/anima_data
...
"""
    ...
    def diagnose(self) -> bool:
        ...
        logger.info("=" * 60)
        logger.info("  Anima Environment Diagnostics")
        logger.info("=" * 60)
...
def main():
    ...
    if args.check:
        ...
        if success:
            ...
            logger.info("")
            logger.info("Next step: python -m anima.socketio_server")
